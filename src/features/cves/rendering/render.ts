...
import type { CveRecord } from "@/config/types";
import { cellWidth, externalLink, padCells, textHtml, wrapWordsCells } from "@/shared/textmode";
...
export function renderCveRegister(records: readonly CveRecord[]): string {
